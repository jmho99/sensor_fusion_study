...
int main(int argc, char **argv)
{
    ...
    std::array<std::array<double, 3>, 3> rotation = {{{0.0020722   , 0.999993, -0.00305748},
                                                      {0.00796851 , -0.0030739 ,  -0.999964},
                                                      {-0.999966,  0.00204776 ,-0.00797482}}};

    std::array<double, 3> translation = {0.00129937 ,-0.0783386 ,-0.0710832};
